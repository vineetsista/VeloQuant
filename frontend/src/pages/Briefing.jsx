  ...
  function handlePrint() {
    ...
    w.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Morning Briefing — ${date}</title><style>
      *{box-sizing:border-box;margin:0;padding:0}
      ...
      <div class="header">
        <div class="brand">RIA Intelligence</div>
        <div class="title">Morning Intelligence Briefing</div>
        <div class="subtitle">${date}</div>
      </div>
      ${bodyHtml}
      <div class="footer">Generated by RIA Intelligence &nbsp;·&nbsp; Not investment advice &nbsp;·&nbsp; For internal use only</div>
    </body></html>`)
    w.document.close()
    w.focus()
    w.print()
